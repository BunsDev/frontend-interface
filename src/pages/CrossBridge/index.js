...
import TokenLogo from "../../components/Logo/CrossTokenLogo";
	...
	function txnsListDtil() {
		...
		let curHash = (
			<MintListVal>
				...
				<CopyButton toCopy={hashCurObj.hash} />
			</MintListVal>
		);
		let outHash = (
			<MintListVal>
				...
				<CopyButton toCopy={hashOutObj.hash} />
			</MintListVal>
		);
		let outStatus = (
		...
		const fromView = (
			<MintList>
				...
				<MintListVal>
					...
					<CopyButton toCopy={mintDtil.from ? mintDtil.from : account} />
				</MintListVal>
			</MintList>
		);
		const toView = (
							...
							<MintDiv>
								...
								<MintList>
									...
									<MintListVal>
										...
										<CopyButton toCopy={registerAddress} />
									</MintListVal>
								</MintList>
								<MintListCenter>
